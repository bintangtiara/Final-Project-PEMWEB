...
<body style="background-image: url(book.png);">
			...
			<nav>
				<ul>
				    ...
				    <li><a href="signup.php">LOGIN/DAFTAR</a></li>
                        <img src="pesan1.png" alt="Mobil 2" style ="position: absolute;
                        width: 346px;
                        height: 175px;
                        left: 300px;
                        top: 326px;
    ...
    <div class="form" style="position: relative; border-radius:20px; border-style: solid; border-color: #D3D3D3; padding: 30px; left:650px; width: 400px; top:300px; margin: auto; background-color: RGB(211, 211, 211,0.5);">
                ...
                <input style="margin-top: 5px; box-sizing: border-box; display: block; width: 100%; padding: 0.375rem 0.75rem; color: #495057; background-color: #ffff; border: 1px solid #ced4da; border-radius: 0.50rem;" 
                type="text" name="nama" required><br>
                
                <label>No.Hp/Whatsapp</label><br>
                <input style="margin-top: 5px; box-sizing: border-box; display: block; width: 100%; padding: 0.375rem 0.75rem; color: #495057; background-color: #ffff; border: 1px solid #ced4da; border-radius: 0.50rem;" 
                type="text" name="nohp" required><br>
                
                <label>Nama Mobil</label><br>
                <select style="margin-top: 5px; box-sizing: border-box; display: block; width: 100%; padding: 0.375rem 0.75rem; color: #495057; background-color: #ffff; border: 1px solid #ced4da; border-radius: 0.50rem;" 
                name="namamobil" required>
                <option value="">Pilih Mobil</option>
                <option value="Fortuner Vrz GR SPORT">Fortuner Vrz GR SPORT</option>
                </select>

                <label>Tanggal Peminjaman</label><br>
                <input style="margin-top: 5px; box-sizing: border-box; display: block; width: 100%; padding: 0.375rem 0.75rem; color: #495057; background-color: #ffff; border: 1px solid #ced4da; border-radius: 0.50rem;" 
                type="date" name="pinjam" placeholder="mm/dd/yy" required><br>
               

                <label>Tanggal Pengembalian</label><br>
                <input style="margin-top: 5px; box-sizing: border-box; display: block; width: 100%; padding: 0.375rem 0.75rem; color: #495057; background-color: #ffff; border: 1px solid #ced4da; border-radius: 0.50rem;" 
                type="date" name="pengembalian" placeholder="mm/dd/yy"required><br>

                <label>Total Unit</label></br>
                <input style="margin-top: 5px; box-sizing: border-box; display: block; width: 100%; padding: 0.375rem 0.75rem; color: #495057; background-color: #ffff; border: 1px solid #ced4da; border-radius: 0.50rem;" 
                type="number" name="unit" required><br>
                
                <label>Total Biaya Sewa</label></br>
                <input style="margin-top: 5px; box-sizing: border-box; display: block; width: 100%; padding: 0.375rem 0.75rem; color: #495057; background-color: #ffff; border: 1px solid #ced4da; border-radius: 0.50rem;" 
                type="text" name="sewa" required><br>
                
                <label>Jenis Jaminan</label><br>
                <input style="margin-top: 5px; box-sizing: border-box; display: block; width: 100%; padding: 0.375rem 0.75rem; color: #495057; background-color: #ffff; border: 1px solid #ced4da; border-radius: 0.50rem;" 
                type="text" name="jaminan" required><br>

                <label>Bukti DP Unit</label></br>
                <input style="margin-top: 5px; box-sizing: border-box; display: block; width: 100%; padding: 0.375rem 0.75rem; color: #495057; background-color: #ffff; border: 1px solid #ced4da; border-radius: 0.50rem;" 
                type="file" name="bukti" required><br>
    ...
    <div style="position: absolute;
        ...
        line-height: 38px;
        color: #000000;">
        <p><b>TOYOTA FORTUNER VRZ GR SPORT 2.4</b></p>
    </div>
